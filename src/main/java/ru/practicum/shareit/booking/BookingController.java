...
public class BookingController {
    ...
    public BookingDtoOut create(@RequestHeader(USER_HEADER) Long userId,
        ...
        log.info("POST запрос на создание нового бронирования вещи:" + bookingDto + " от пользователя c id: " + userId);
    ...
    public BookingDtoOut updateStatus(@RequestHeader(USER_HEADER) Long userId,
        ...
        log.info("PATCH запрос на обновление статуса бронирования вещи : " + bookingId + "от владельца с id: " + userId);
    ...
    public List<BookingDtoOut> findAll(@RequestHeader(USER_HEADER) Long userId,
        ...
        log.info("GET запрос на получение списка всех бронирований текущего пользователя с id: " + userId + "и статусом " + bookingState);
    ...
    public List<BookingDtoOut> getAllOwner(@RequestHeader(USER_HEADER) Long ownerId,
                                           @RequestParam(value = "state", defaultValue = "ALL") String bookingState) {
        log.info("GET запрос на получение списка всех бронирований текущего владельца с id: " + ownerId + "и статусом " + bookingState);
